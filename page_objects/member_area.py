...
class MemberArea():
    ...
    def when_i_log_out_of_the_member_area(self):
        self.wait.until(element_to_be_clickable(self.lbl_member_name_header))
        self.driver.find_element(*self.lbl_member_name_header).click()
        self.wait.until(visibility_of_element_located(self.btn_logout))
